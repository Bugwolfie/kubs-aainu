...
'''set2 = {23, 25, 29, "paridha", [12, 2, 17, 62]}
print(set2) '''
#will throw an error as list inside the set is a mutable item
...
present in set rremove function will throw error while discard function will 
